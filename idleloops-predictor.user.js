// ==UserScript==
// @name         IdleLoops Predictor Makro indev
        ...
        `;
            ...
            initPredictions() {
                ...
                const predictions = {
                    ...
                    'Buy Mana Z1': {
                        affected: ['mana', 'gold'],
                        effect: (r) => (r.mana += r.gold * g.Action.BuyManaZ1.goldCost(), r.gold = 0)
                    },
                    'Meet People': {},
                    'Train Strength': {},
                    'Short Quest': {
                    ...
                    'Warrior Lessons': {
                        effect: (r, k) => k.combat += 100,
                        canStart: (input) => input.rep >= 2
                    },
                    'Mage Lessons': {
                        effect: (r, k) => k.magic += 100 * (1 + g.getSkillLevelFromExp(k.alchemy) / 100),
                        canStart: (input) => input.rep >= 2
                    },
                    'Buy Supplies': {
                        affected: ['gold'],
                    ...
                    'Buy Mana Z3': {
                        affected: ['mana', 'gold'],
                        effect: (r) => (r.mana += r.gold * g.Action.BuyManaZ3.goldCost(), r.gold = 0)
                    },
                    'Sell Potions': {
                        affected: ['gold', 'potions'],
                        effect: (r, k) => (r.gold += r.potions * g.getSkillLevelFromExp(k.alchemy), r.potions = 0)
                    },
                    'Read Books': {},
                    'Gather Team': {
                        affected: ['gold'],
                    ...
                    'Apprentice': {
                        effect: (r, k) => (r.apprentice = (r.apprentice || 0) + 30 * h.getGuildRankBonus(r.crafts || 0), k.crafting += 10 * (1 + h.getTownLevelFromExp(r.apprentice) / 100))
                    },
                    'Mason': {
                        effect: (r, k) => (r.mason = (r.mason || 0) + 20 * h.getGuildRankBonus(r.crafts || 0), k.crafting += 20 * (1 + h.getTownLevelFromExp(r.mason) / 100))
                    },
                    'Architect': {
                        effect: (r, k) => (r.architect = (r.architect || 0) + 10 * h.getGuildRankBonus(r.crafts || 0), k.crafting += 40 * (1 + h.getTownLevelFromExp(r.architect) / 100))
                    },
                    'Buy Pickaxe': {
                        affected: ['gold'],
                    ...
                    'Pyromancy': {
                        effect: (r, k) => k.pyromancy += 100
                    },
                    'Looping Potion': {
                        affected: ['herbs', 'lpotions'],
                        effect: (r, k) => {
                            if (r.herbs >= 200) {
                    ...
                    'Buy Mana Z5': {
                        affected: ['mana', 'gold'],
                        effect: (r) => (r.mana += r.gold * g.Action.BuyManaZ5.goldCost(), r.gold = 0)
                    },
                    'Sell Artifact': {
                    ...
                    'Charm School': {},
                    'Enchant Armor': {
                        affected: ['armor', 'favor', 'enchantments'],
                        canStart: (input) => {
                    ...
                    'Adventure Guild': {
                        ...
                        loop: {
                            ...
                            effect: {
                                segment: (r) => (r.mana += 200, r.adventures++)
                            }
                        }
                    },
                    'Crafting Guild': {
                        ...
                        loop: {
                            ...
                            effect: {
                                segment: (r, k) => (r.gold += 10, r.crafts++, k.crafting += 50)
                            }
                        }
                    },
                    'Hunt Trolls': {
                        ...
                        loop: {
                            ...
                            tick: (p, a, s, k, r) => offset => (h.getSelfCombat(r, k) * Math.sqrt(1 + p.total / 100) * (1 + g.getLevelFromExp(s[a.loopStats[(p.completed + offset) % a.loopStats.length]]) / 100)),
                            effect: {
                                loop: (r, k) => (r.blood++, k.combat += 1000)
                            }
                        }
                    },
                    ...
                    'Large Dungeon': {
                        ...
                        loop: {
                            ...
                            effect: {
                                end: (r, k) => (k.combat += 15, k.magic += 15),
                                loop: (r) => r.soul += 10
                            }
                        }
                    },
            ...
            update(actions, container, isDebug) {
                ...
                const snapshots = {
                    ...
                    currProgress: new Koviko.Snapshot({
                        "Fight Monsters": 0,
                        "Heal The Sick": 0,
                        "Small Dungeon": 0,
                        "Large Dungeon": 0,
                ...
                actions.forEach((listedAction, i) => {
                    ...
                    if (prediction) {
                        ...
                        for (let loop = 0; loop < listedAction.loops; loop++) {
                            ...
                            if (!canStart || listedAction.disabled) {
                                break;
                            }
                ...
                while (ms.toString().length < percisionForTime) {
                    ms = "0" + ms;
                }
